...
function ContactContent() {
  ...
  return (
    <>
      ...
      {/* Hero Header */}
      <section className="relative min-h-[40vh] flex items-center justify-center bg-black overflow-hidden pt-28 pb-16">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-20 text-center">
          ...
          <p className="font-body text-zinc-400 text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
            Have questions about signboards, digital displays, print orders, or class schedules? Reach out to our design estimators.
          </p>
        </div>
      </section>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left font-body">
                  ...
                  <p className="text-xs text-zinc-500">Instant connection with estimators</p>
                </div>
              </div>
              <span className="text-zinc-600 group-hover:text-brand transition-colors text-sm">→</span>
            </a>
          </div>
